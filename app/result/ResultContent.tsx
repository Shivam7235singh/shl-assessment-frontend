...
export default function ResultContent() {
  ...
  const parseAIRecommendation = (text: string) => {
    if (!text) return null;
  ...
  const parseAssessments = (section: string) => {
      ...
      <div className="max-w-4xl mx-auto px-4">
            ...
            {aiData.assessments && aiData.assessments.length > 0 && (
              <div>
                ...
                <div className="space-y-4">
                  {aiData.assessments.map((assessment: any, index: number) => (
        ...
        {data.results && data.results.length > 0 && (
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              {data.results.map((assessment: any, index: number) => (
                  ...
                  {assessment.skills_measured && assessment.skills_measured.length > 0 && (
                    <div className="mb-3">
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {assessment.skills_measured.map((skill: string, skillIndex: number) => (
                          <span 
                            key={skillIndex}
